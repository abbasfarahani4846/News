...
namespace News.Models.ViewModels
{
    public class NewsDetailsViewModel
    {
        ...
        public List<News.Models.Db.PopularNews> PopularNews { get; set; } = new List<News.Models.Db.PopularNews>();
        public List<News.Models.Db.PopularCategory> PopularCategories { get; set; } = new List<News.Models.Db.PopularCategory>();
    }
}
